...
import { EditOutlined, CheckOutlined, UploadOutlined, UserSwitchOutlined, QuestionOutlined, CloseOutlined } from '@ant-design/icons';
...
const CourseView = () => {
  ...
  const handlePublish = async (e, courseId) => {
    ...
    // return;
    try {
      let answer = window.confirm('Once you publish your course, it will be live in the marketplace for students to enroll.');
      if (!answer) return;
  ...
  const handleUnpublish = async (e, courseId) => {
    ...
    // return;
    try {
      let answer = window.confirm('Once you unpublish your course, it will not appear in the marketplace for students to enroll.');
      if (!answer) return;
